...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        ...
        if not Users.objects.exists():
            default_users = [
                {"username": "andrew@insite.4cd.edu","email": "andrew@insite.4cd.edu","DVC_ID": "0000002","role": "admin","first_name": "Andrew"},
                {"username": "frank@insite.4cd.edu","email": "frank@insite.4cd.edu","DVC_ID": "0000003","role": "admin","first_name": "Frank"},
                {"username": "heidi@insite.4cd.edu","email": "heidi@insite.4cd.edu","DVC_ID": "0000004","role": "admin","first_name": "Heidi"},
                {"username": "hoang@insite.4cd.edu","email": "hoang@insite.4cd.edu","DVC_ID": "0000005","role": "admin","first_name": "Hoang"},
                {"username": "kayla@insite.4cd.edu","email": "kayla@insite.4cd.edu","DVC_ID": "0000006","role": "admin","first_name": "Kayla"},
                {"username": "seokyoung@insite.4cd.edu","email": "seokyoung@insite.4cd.edu","DVC_ID": "0000007","role": "admin","first_name": "Seokyoung"},
                {"username": "dvc_user@insite.4cd.edu","email": "dvc_user@insite.4cd.edu","DVC_ID": "0000008","role": "user","first_name": "User"},
            ]

            for u in default_users:
                user_obj = User.objects.create_user(username=u["username"], email=u["email"], password="password", first_name=u.get("first_name", "User"))
